...
<style>
  ...
  *,*::before,*::after{ box-sizing:border-box; }
  ...
  .hero-copy .hero-note.alt{ margin-top:.55rem; }
  ...
  .lean-viz .donut-note{ text-align:center; font-size:.82rem; color:var(--muted); margin:1.2rem auto 0; max-width:36ch; line-height:1.5; }
  ...
  .pilot .pilot-note{ text-align:center; margin:clamp(28px,3.4vw,44px) auto 0; font-weight:600; color:#fff !important; font-size:1rem; max-width:680px; line-height:1.5; }
  ...
  .foot-credit{ font-size:.86rem !important; margin-top:.8rem !important; color:#7f939a !important; }
  .foot-credit a{ color:#c3d2d7; text-decoration:underline; text-underline-offset:2px; }
  ...
  @media (max-width:960px){
    .hero-grid{ grid-template-columns:1fr; } .hero-art{ max-width:520px; margin:1.5rem auto 0; }
    ...
    /* stop the hero image's floating chip/decorations from overlapping the copy */
    .hero-art .dots, .hero-art .blob{ display:none; }
    .hero-art .chip{ position:static; margin:.9rem auto 0; width:max-content; max-width:100%; }
  }
    ...
    <div class="cfa-wrap">
      <div class="hero-grid">
        <div class="hero-copy reveal">
          ...
          <p class="hero-note alt">Not a Chick-fil-A team? <a href="https://learn.cfalean365.com/">Access the LEAN365 platform →</a></p>
        </div>
    ...
    <div class="cfa-wrap">
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p>Helping teams create capacity and build a lasting culture of continuous improvement.</p>
          <p class="foot-credit">In partnership with Chick-fil-A · A <a href="https://circleksolutions.com/" target="_blank" rel="noopener">Circle&nbsp;K Supply&nbsp;Chain Solutions</a> company.</p>
        </div>
        ...
        <div><h4>Access</h4><ul><li><a data-login href="#">Member Login</a></li><li><a data-login href="#">Learning Portal</a></li><li><a href="https://learn.cfalean365.com/" target="_blank" rel="noopener">LEAN365 platform (non-CFA)</a></li><li><a href="#interest">Express Interest</a></li></ul></div>
      ...
      <div class="foot-bottom">
        <span>© <span id="cfaYear"></span> LEAN365 · <a href="https://circleksolutions.com/" target="_blank" rel="noopener">Circle&nbsp;K Supply&nbsp;Chain Solutions</a>. All rights reserved.</span>
