...
<style>
  ...
  @font-face{ font-family:'Apercu Pro'; src:url('/wp-content/uploads/et-fonts/ApercuPro.ttf') format('truetype'); font-weight:100 900; font-style:normal; font-display:swap; }
  @font-face{ font-family:'Apercu';     src:url('/wp-content/uploads/et-fonts/ApercuPro.ttf') format('truetype'); font-weight:100 900; font-style:normal; font-display:swap; }
  *,*::before,*::after{ box-sizing:border-box; }
  ...
  .btn{ --_bg:var(--red); --_fg:#fff; --_bd:var(--red);
    ...
    padding:.92em 1.75em; border-radius:var(--r-pill); background:var(--_bg); color:var(--_fg); border:2px solid var(--_bd); cursor:pointer;
    ...
    box-shadow:var(--shadow-sm); white-space:nowrap; max-width:100%; text-align:center; }
  .btn:hover{ transform:translateY(-2px); box-shadow:var(--shadow-md); background:var(--red-dark); border-color:var(--red-dark); }
  .btn:active{ transform:translateY(0); }
  .btn--navy{ --_bg:var(--navy); --_bd:var(--navy); } .btn--navy:hover{ background:var(--navy-dark); border-color:var(--navy-dark); }
  .btn--ghost{ --_bg:transparent; --_fg:var(--navy); --_bd:var(--navy); box-shadow:none; } .btn--ghost:hover{ background:var(--navy); color:#fff; }
  .btn--light{ --_bg:#fff; --_fg:var(--red); --_bd:#fff; } .btn--light:hover{ background:var(--red-soft); border-color:var(--red-soft); color:var(--red-dark); }
  ...
  .donut-note{ font-size:.8rem; color:var(--muted); margin:1rem auto 0; max-width:38ch; }
  ...
  .statc{ background:#fff; border:1px solid var(--line); border-radius:var(--r-lg); padding:clamp(20px,2.6vw,30px); box-shadow:var(--shadow-sm); position:relative; overflow:hidden; }
  .statc::before{ content:""; position:absolute; right:-18px; top:-18px; width:76px; height:76px; color:var(--red); background:var(--dots); background-size:13px 13px; opacity:.32; }
  .statc .n{ font-family:var(--font-head); font-weight:900; font-size:clamp(2.1rem,4vw,3rem); line-height:1; color:var(--navy); }
  .statc:nth-child(odd) .n{ color:var(--red); }
  .statc .l{ font-size:.9rem; color:var(--ink-soft); margin-top:.5rem; }
  ...
  .ppath .ps::after{ content:""; position:absolute; top:26px; left:62%; right:-38%; height:2px; color:var(--gold); background:var(--dots); background-size:12px 2px; opacity:.6; }
  ...
  .pilot-note{ text-align:center; margin-top:clamp(26px,3vw,40px); font-weight:600; color:rgba(255,255,255,.92); display:flex; align-items:center; justify-content:center; gap:.6rem; flex-wrap:wrap; }
  .pilot-note svg{ width:20px; height:20px; color:var(--gold); flex:0 0 auto; }
  ...
  .forms-grid{ display:grid; grid-template-columns:1fr 1fr; gap:clamp(24px,3.5vw,44px); align-items:start; }
  ...
  /* --- Pilot-card polish: tighter spacing + visible address label + nicer suggestions --- */
  .form-card .gform_wrapper .gform_fields{ display:grid !important; grid-template-columns:1fr !important; grid-row-gap:14px !important; row-gap:14px !important; }
  .form-card .gform_wrapper .gfield{ margin:0 !important; padding:0 !important; }
  .form-card .gform_wrapper .gsection,.form-card .gform_wrapper .gfield--type-section{ margin:.2rem 0 !important; padding:0 !important; border:0 !important; min-height:0 !important; }
  .form-card .gform_wrapper .gsection .gsection_title{ display:none !important; }
  .form-card .gform_wrapper .ginput_complex label,.form-card .gform_wrapper .gfield_label{ margin-bottom:.3rem !important; }
  .form-card .cfa-input-wrapper{ margin:0 !important; }
  /* store-address label — force visible/white on the red card */
  .form-card .cfa-input-wrapper label{ font-family:var(--font-head) !important; font-weight:600 !important; font-size:.9rem !important; margin-bottom:.35rem !important; display:block; }
...
<noscript><style>.reveal{opacity:1 !important;transform:none !important}</style></noscript>
  ...
  <div class="cfa-topbar">
    Pilot Cohort 1 kicks off <strong>July&nbsp;2026</strong> — a second cohort of 100 restaurants follows January&nbsp;2027. <a href="#interest">Express your interest →</a>
  </div>
    ...
    <div class="cfa-wrap">
      ...
      <div class="cards">
        ...
        <article class="rcard reveal">
          ...
          <div class="body"><h3>Retain</h3><p>Participants are more likely to stay — a <span class="kpi">70% retention rate</span> among Team Members who take part in LEAN365 Essentials.</p></div>
        </article>
        <article class="rcard reveal">
  ...
  <section class="cfa-section pilot" id="pilot" aria-labelledby="pilotTitle">
    <div class="cfa-wrap">
      <div class="center reveal">
        ...
        <p class="lead">A simple, supported path — six steps from expressing interest to launching with your cohort.</p>
      </div>
      <div class="ppath">
      ...
      <p class="pilot-note"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> Throughout the process, CFA and the training team provide support — Operators are never on their own.</p>
    ...
    <div class="cfa-wrap">
      <div class="cta-inner reveal">
        ...
        <div class="hero-cta">
          ...
          <a class="btn btn--lg" data-login href="#" style="background:transparent;border-color:#fff;color:#fff">Member Login</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer class="cfa-footer">
    <div class="cfa-wrap">
      <div class="foot-grid">
        ...
        <div><h4>Contact</h4><ul><li><a href="#support">Contact Support</a></li><li><a href="mailto:info@cfalean365.com">info@cfalean365.com</a></li></ul></div>
      </div>
