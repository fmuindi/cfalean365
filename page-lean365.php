...
<style>
  ...
  :root{
    ...
    --font-head:"Aptos Display","Aptos","Poppins","Segoe UI",system-ui,sans-serif;
    --font-body:"Calibri","Carlito","Lato","Segoe UI",system-ui,sans-serif;
  ...
  *,*::before,*::after{ box-sizing:border-box; }
  ...
  .hero h1{ font-size:clamp(2.35rem,5.4vw,4.2rem); font-weight:900; }
  ...
  /* ====================== MARQUEE ====================== */
  .marquee{ background:var(--red); color:#fff; overflow:hidden; }
  .marquee .track{ display:flex; align-items:center; gap:2.2rem; white-space:nowrap; width:max-content; animation:marq 32s linear infinite; padding:.85rem 0; }
  .marquee .track span{ font-family:var(--font-head); font-weight:800; text-transform:uppercase; letter-spacing:.08em; font-size:.95rem; display:inline-flex; align-items:center; gap:2.2rem; }
  .marquee .track b{ opacity:.55; }
  ...
  .cfa-mobile{ position:fixed; inset:82px 0 auto 0; background:var(--cream); border-bottom:1px solid var(--line); box-shadow:var(--shadow-md); transform:translateY(-140%); transition:transform .32s var(--ease); z-index:55; padding:1.2rem clamp(20px,5vw,40px) 1.6rem; }
...
<div class="cfa-topbar">
  ...
  <div class="marquee" aria-hidden="true">
    <div class="track">
      <span>Engage <b>·</b> Retain <b>·</b> Reward <b>·</b> Create Capacity <b>·</b> Continuous Improvement <b>·</b> Our Pleasure <b>·</b></span>
      <span>Engage <b>·</b> Retain <b>·</b> Reward <b>·</b> Create Capacity <b>·</b> Continuous Improvement <b>·</b> Our Pleasure <b>·</b></span>
    </div>
  </div>
...
(function(){
  ...
  if(burger&&mobile){ burger.addEventListener('click',function(){ var o=burger.getAttribute('aria-expanded')==='true'; burger.setAttribute('aria-expanded',String(!o)); mobile.classList.toggle('open',!o); });
