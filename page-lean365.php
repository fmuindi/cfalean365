...
<style>
  ...
  *,*::before,*::after{ box-sizing:border-box; }
  ...
  .hero-note{ margin-top:2.8rem; font-size:.92rem; color:var(--muted); }
  ...
  .pilot-note{ text-align:center; margin-top:clamp(28px,3.4vw,44px); font-weight:600; color:#fff !important; font-size:1rem; display:flex; align-items:center; justify-content:center; gap:.6rem; flex-wrap:nowrap; max-width:760px; margin-inline:auto; }
  @media (max-width:560px){ .pilot-note{ flex-wrap:wrap; } }
  ...
  /* force EVERY control + its container to full, uniform width & height */
  .form-card .gform_wrapper .gfield,
  .form-card .gform_wrapper .ginput_container,
  .form-card .gform_wrapper .ginput_complex,
  .form-card .cfa-input-wrapper{ width:100% !important; max-width:100% !important; }
  .form-card .gform_wrapper input:not([type=submit]):not([type=button]):not([type=checkbox]):not([type=radio]),
  .form-card .gform_wrapper textarea,
  .form-card .gform_wrapper select,
  .form-card .cfa-autocomplete{ width:100% !important; max-width:100% !important; min-height:50px !important; box-sizing:border-box !important; }
  .form-card .gform_wrapper textarea{ min-height:120px !important; }
  .form-card .gform_wrapper .ginput_complex > span{ width:100% !important; display:block; }
